    ...
    def blitme(self):
        ...
        if 'base' in self.type:
            ...
            if '_u' in self.type:
                ...
                self.screen.fill(self.settings.alt_team_color['g'], self.rect)
                pygame.draw.circle(self.screen, self.settings.b_w_team_color['g'], self.rect.center, 10)
                pygame.draw.circle(self.screen, self.settings.team_color['g'], self.rect.center, 6)

            elif '_m' in self.type:
                self.screen.fill(self.settings.alt_team_color['m'], self.rect)
                pygame.draw.circle(self.screen, self.settings.b_w_team_color['m'], self.rect.center, 10)
                pygame.draw.circle(self.screen, self.settings.team_color['m'], self.rect.center, 6)
