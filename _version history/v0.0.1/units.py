...
class _SuperUnit(Sprite):
    ...
    def __init__(self, lf_game, team):
        ...
        self.uncharged_image = pygame.image.load('images/uncharged.png')
        self.charging_image = pygame.image.load('images/charging.png')
        self.selected_image = pygame.image.load('images/unit_selected.png')
