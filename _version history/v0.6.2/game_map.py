...
# NEED TO RECORD TEAM BASES BEFORE TURNING ON

    # def eliminate_unit(self, unit):
    #     """delete the unit IF there are no friendly bases on the map"""
    #     friendly_base_found = False
    #     for base_position in self.base_positions:
    #         if base_position['team'] == unit.team:
    #             friendly_base_found = True
    #     if not friendly_base_found:
    #         print(f'{unit.unit_class} eliminated')
    #         unit.kill()
