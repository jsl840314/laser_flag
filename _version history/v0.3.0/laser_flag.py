...
from lf_functions import determine_range, find_targets, show_los, D6
...
class LaserFlag:
        ...
        if self.selected_unit:
            for unit in enemy_team:
                ...
                if unit_clicked and unit.visible:
                    ...
                    # if there was not target selected, just pick this one
                    else:
                        self.targeted_unit = unit
                        self.targeted_unit.targeted = True
    ...
    def _check_button_clicks(self, mouse_pos):
        ...
        if laser_button_clicked and self.laser_button.visible:
            self._fire_laser()
        elif turn_button_g_clicked and self.team_green_turn:
