...
class ButtonFrame():
    ...
    def create_buttons(self, lf_game):
        ...
        lf_game.turn_button['g'] = Button(lf_game, msg="END TURN",
            color=self.settings.team_color['g'],
            text_color=self.settings.b_w_team_color['g'],
            border_color=self.settings.alt_team_color['g'],
            border_weight = 2,
            grid_position=(3, 1),
            width=3,
            alt_image=pygame.image.load('images/the_ever_seeing_eye.png'))

        lf_game.score_label['g'] = Button(lf_game, msg='0',
            color=self.settings.team_color['g'],
            text_color=self.settings.b_w_team_color['g'],
            border_color=self.settings.alt_team_color['g'],
            border_weight = 5,
        ...
        lf_game.status_label['g'] = Button(lf_game, msg='',
            color=self.settings.team_color['g'],
            text_color=self.settings.b_w_team_color['g'],
            border_color=self.settings.alt_team_color['g'],
            border_weight = 5,
        ...
        lf_game.turn_button['m'] = Button(lf_game, msg="END TURN",
            color=self.settings.team_color['m'],
            text_color=self.settings.b_w_team_color['m'],
            border_color=self.settings.alt_team_color['m'],
            border_weight = 2,
            grid_position=(3, 19),
            width=3,
            alt_image=pygame.image.load('images/the_ever_seeing_eye.png'),
        ...
        lf_game.score_label['m'] = Button(lf_game, msg='0',
            color=self.settings.team_color['m'],
            text_color=self.settings.b_w_team_color['m'],
            border_color=self.settings.alt_team_color['m'],
            border_weight = 5,
        ...
        lf_game.status_label['m'] = Button(lf_game, msg='',
            color=self.settings.team_color['m'],
            text_color=self.settings.b_w_team_color['m'],
            border_color=self.settings.alt_team_color['m'],
            border_weight = 5,
        ...
        lf_game.overwatch_message = Button(lf_game, "",
            color='red', text_color='black',
            border_color='black', border_weight = 5,
            grid_position=(0.5, 9),
            width=8, height=3, visible=False)
        ...
        lf_game.buttons = (
            lf_game.turn_button['g'],
            lf_game.score_label['g'],
            lf_game.status_label['g'],
            lf_game.turn_button['m'],
            lf_game.score_label['m'],
            lf_game.status_label['m'],
            lf_game.rules_button,
            lf_game.overwatch_message,
