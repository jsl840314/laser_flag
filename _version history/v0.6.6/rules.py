...
class Rules():
    ...
    def _draw_misc_icons(self):
        ...
        self.icon_ap = pygame.image.load('images/unit_status_ap_2.png')
    ...
    def show(self):
        ...
        self.screen.blit(self.icon_ap, (
            self.rect.x + t*19.6, self.rect.y + t*15))
        self.screen.blit(self.icon_ap, (
            self.rect.x + t*19.9, self.rect.y + t*15))
        self.screen.blit(self.icon_sn, (
            self.rect.x + t*24.2, self.rect.y + t*15))

        self.screen.blit(self.icon_un, (
            self.rect.x + t*19.5, self.rect.y + t*15.6))
        self.screen.blit(self.icon_ch, (
            self.rect.x + t*24, self.rect.y + t*15.6))
