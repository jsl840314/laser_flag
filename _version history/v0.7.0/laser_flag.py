    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            ...
            # if mouse click
                ...
                # if the rules or roll result panes were open, just close them
                if self.show_rules:
                    self.show_rules = False
        ...
        for tile in self.game_map.all_tiles:
            ...
            if tile_clicked:
                ...
                if (self.selected_unit and tile.hilited):
                    ...
                    # clear the selection if the unit has used its last AP
...
################################################################################
    ...
    def _on_click_unit(self, clicked_unit):
        ...
        # if there was already a selection, just clear
...
################################################################################
    ...
    def _fire_laser(self, shooter, target, overwatch=False):
        ...
        laser_color_1 = self.settings.team_color[shooter.team]
        laser_color_2 = self.settings.alt_team_color[shooter.team]
        laser_color_3 = self.settings.b_w_team_color[shooter.team]

        # draw a few lasers, take enough time to see the shot before
        #   displaying the roll result message
        for i in range(0, 15):
            pygame.draw.line(self.screen, laser_color_1,
                (sight_line.A.x, sight_line.A.y),
                (sight_line.B.x, sight_line.B.y), 15)
            pygame.draw.line(self.screen, laser_color_2,
                (sight_line.A.x, sight_line.A.y),
                (sight_line.B.x, sight_line.B.y), 9)
            pygame.draw.line(self.screen, laser_color_3,
                (sight_line.A.x, sight_line.A.y),
                (sight_line.B.x, sight_line.B.y), 3)
...
################################################################################
    ...
    def _run_overwatch(self, target):
        ...
        # OVERWATCH MODE IS TURNED OFF FOR TESTING
        # return
        ...
        for shooter in random_shooters:
            ...
            # use the laser button to show the snapshot roll
...
################################################################################
    ...
    def _update_screen(self):
        ...
        # show the result of th elast dice roll
