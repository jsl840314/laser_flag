...
################################################################################
    ...
    def _read_map(self):
            ...
            for c, code in enumerate(row_list):
                ...
                # if it's a base add it to that list
                    ...
                    if '_u' in new_tile.type:
                        self.bases['g'].append(new_tile)
                        self.bases['m'].append(new_tile)
                    elif '_g' in new_tile.type:
                        self.bases['g'].append(new_tile)
                    elif '_m' in new_tile.type:
                        self.bases['m'].append(new_tile)
        ...
        print(f"team 1 bases: {self.bases['g']}")
        print(f"team 2 bases: {self.bases['m']}")
