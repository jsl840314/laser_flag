...
class LaserFlag:
    ...
    def __init__(self, map_file):
        ...
        self.score_label_g = Button(self, msg='0',
            ...
            grid_position=(3.5, 3), width=2, height=2)
        ...
        self.score_label_m = Button(self, msg='0',
            ...
            border_color='black', border_weight = 5,
            grid_position=(3.5, 16), width=2, height=2)
    ...
    def _generate_background_lasers(self):
        ...
        for i in range(0, 10):
            ...
            self.background_lasers.append(Line((0, y1), (w, y2)))
        for i in range(0, 10):
            x1 = choice(range(0, w))
            x2 = choice(range(0, w))
            color = choice(['cyan', 'red'])
            self.background_lasers.append(Line((x1, 0), (x2, h)))
    ...
    def _draw_background_lasers(self):
        ...
        for line in self.background_lasers:
            pygame.draw.line(self.screen, laser_color, line.A, line.B)
