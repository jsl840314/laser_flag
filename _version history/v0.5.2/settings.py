...
class Settings:
    ...
    def __init__(self):
        ...
        self.team_color     ['g'] = (000, 255, 000)
        self.alt_team_color ['g'] = (000, 000, 255)
        self.b_w_team_color ['g'] = 'black'

        self.team_color     ['m'] = (255, 000, 255)
        self.alt_team_color ['m'] = (255, 255, 000)
        ...
        self.score_limit_g   = 21
        self.score_limit_m   = 21
