...
class MapEditor:
    ...
    def __init__(self):
        ...
        filename = tkinter.filedialog.askopenfilename(
            ...
            initialdir='maps')
        if filename == '':
            filename = 'maps/__empty map.txt'
        self.game_map = GameMap(self, filename)
        self.all_units = []
        ...
        self.mode_button[self.modes[3]] = Button(self, "TEAM 1 UNITS",
            color=self.button_colors['color'],
            text_color=self.button_colors['text'],
            border_color=self.button_colors['border'],
            sel_color=self.button_colors['sel color'],
        ...
        self.mode_button[self.modes[4]] = Button(self, "TEAM 2 UNITS",
            color=self.button_colors['color'],
            text_color=self.button_colors['text'],
            border_color=self.button_colors['border'],
            sel_color=self.button_colors['sel color'],
