...
class Settings:
    ...
    def __init__(self):
        ...
        self.base_to_hit              = +7  # lower value  -> better shooter
        ...
        self.score_limit = {}
        self.score_limit[self.teams[0]] = 21
        self.score_limit[self.teams[1]] = 21
        ...
        self.tile_dict = {
            ...
            '_': 'level',
            'B': 'base_u',
            '1': f'base_{self.teams[0]}',
            '2': f'base_{self.teams[1]}',
            'g': f'unit_{self.teams[0]}_basic',
            'h': f'unit_{self.teams[0]}_sniper',
            'i': f'unit_{self.teams[0]}_grunt',
            'j': f'unit_{self.teams[0]}_scout',
            'm': f'unit_{self.teams[1]}_basic',
            'n': f'unit_{self.teams[1]}_sniper',
            'o': f'unit_{self.teams[1]}_grunt',
            'p': f'unit_{self.teams[1]}_scout'
        }
