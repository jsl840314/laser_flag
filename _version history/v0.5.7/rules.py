...
class Rules():
    ...
    def _draw_tile_icons(self):
        ...
        self.tiles = [Tile(self, {'row': 1.5, 'col': 20, 'occupied': False, 'type': 'wall', 'ID': 0}),
                      Tile(self, {'row': 4.5, 'col': 20, 'occupied': False, 'type': 'elevated', 'ID': 0}),
                      Tile(self, {'row': 7.5, 'col': 20, 'occupied': False, 'type': 'level', 'ID': 0}),
                      Tile(self, {'row': 10.5, 'col': 20, 'occupied': False, 'type': 'base_g', 'ID': 0}),
                      Tile(self, {'row': 13.5, 'col': 20, 'occupied': False, 'type': 'base_m', 'ID': 0})]
