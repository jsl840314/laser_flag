...
class MapEditor:
    ...
    def __init__(self):
        ...
        if self.filename == '':
            ...
            self.map_name = os.path.split(self.filename)[1]
        ...
        # show the map name
        self.map_nameplate = Button(self, self.map_name, color=self.team_panel_color,
            text_color='white', border_color='black', border_weight=0,
            grid_position=(26, 0.5), justify='center')

        # rects around each team's button group
        t = self.settings.tile_size
        self.edit_btn_rect = pygame.Rect(t*21.75, t*0.5, t*9.5, t*2.5)
        self.team_1_rect   = pygame.Rect(t*21.75, t*3.25, t*4.5, t*14)
        self.team_2_rect   = pygame.Rect(t*26.75, t*3.25, t*4.5, t*14)


        # tile editing mode buttons
        ...
        self.mode_button[self.modes[1]] = Button(self, "EDIT TERRAIN",
            ...
            border_weight = 1,
            grid_position = (22, 1.75), width=4, height=1, visible=True)
        self.mode_button[self.modes[2]] = Button(self, "EDIT BASES",
            ...
            sel_border_color=self.button_colors['sel border'],
            border_weight = 1,
            grid_position = (27, 1.75), width=4, height=1, visible=True)

        # unit editing mode buttons
        self.mode_button[self.modes[3]] = Button(self, "PLACE UNITS",
            color=self.button_colors['color'],
            text_color=self.button_colors['text'],
            border_color=self.button_colors['border'],
            sel_color=self.button_colors['sel color'],
            ...
            grid_position = (22, 3.5), width=4, height=1, visible=True)
        self.mode_button[self.modes[4]] = Button(self, "PLACE UNITS",
            color=self.button_colors['color'],
            text_color=self.button_colors['text'],
            border_color=self.button_colors['border'],
            sel_color=self.button_colors['sel color'],
            ...
            sel_border_color=self.button_colors['sel border'],
            border_weight = 1, font_factor = 0.7,
            grid_position = (27, 3.5), width=4, height=1, visible=True)

        # team names
        self.team_name = {
            '1': Button(self, self.settings.team_names['1'],
                color=self.settings.team_color['1'],
                text_color=self.settings.b_w_team_color['1'],
                border_color=self.settings.alt_team_color['1'],
                border_weight = 2,
                grid_position = (22, 4.75), width=4, height=0.8, visible=True),

            '2': Button(self, self.settings.team_names['2'],
                color=self.settings.team_color['2'],
                text_color=self.settings.b_w_team_color['2'],
                border_color=self.settings.alt_team_color['2'],
                border_weight = 2,
                grid_position = (27, 4.75), width=4, height=0.8, visible=True),
        }


        # color pickers
        self.color_pickers = {
            '1 main': ColorPicker(self, (22, 5.75), label='Main Color'),
            '2 main': ColorPicker(self, (27, 5.75), label='Main Color'),
        ...
        self.b_w_button['1'] = Button(self, "ICON COLOR",
            ...
            border_weight = 1,
            grid_position = (22, 14.25), width=4, height=1, visible=True)
        self.b_w_button['2'] = Button(self, "ICON COLOR",
            ...
            sel_border_color=self.button_colors['border'],
            border_weight = 1,
            grid_position = (27, 14.25), width=4, height=1, visible=True)
        ...
        self.score_buttons = {
            'label 1': Button(self, "SCORE LIMIT",
                    ...
                    grid_position = (23.5, 15.4), height=0.65, justify='center',
                    font_factor=0.5),
            'label 2': Button(self, "SCORE LIMIT",
                    color=self.team_panel_color,
                    text_color=self.button_colors['text'],
                    border_color=self.team_panel_color,
                    grid_position = (28.5, 15.4), height=0.65, justify='center',
                    font_factor=0.5),
            'down arrow 1': Button(self, "<",
                    ...
                    border_color='white',
                    border_weight = 1,
                    grid_position = (22.5, 16), width=1, height=1, visible=True),
            'score 1': Button(self, "0",
                    color=self.team_panel_color,
                    text_color='white',
                    border_color='black',
                    border_weight = 0,
                    grid_position = (23.5, 16), width=1, height=1, visible=True),
            'up arrow 1': Button(self, ">",
                    color=self.team_panel_color,
                    text_color='white',
                    border_color='white',
                    border_weight = 1,
                    grid_position = (24.5, 16), width=1, height=1, visible=True),
            'down arrow 2': Button(self, "<",
                    color=self.team_panel_color,
                    text_color='white',
                    border_color='white',
                    border_weight = 1,
                    grid_position = (27.5, 16), width=1, height=1, visible=True),
            'score 2': Button(self, "0",
                    color=self.team_panel_color,
                    text_color='white',
                    border_color='black',
                    border_weight = 0,
                    grid_position = (28.5, 16), width=1, height=1, visible=True),
            'up arrow 2': Button(self, ">",
                    color=self.team_panel_color,
                    text_color='white',
                    border_color='white',
                    border_weight = 1,
                    grid_position = (29.5, 16), width=1, height=1, visible=True)
        }
...
################################################################################
    ...
    def _check_button_clicks(self, mouse_pos):
        ...
        # nameplates
        name_1_clicked = self.team_name['1'].rect.collidepoint(mouse_pos)
        name_2_clicked = self.team_name['2'].rect.collidepoint(mouse_pos)
        if name_1_clicked:
            self._change_team_name('1')
        elif name_2_clicked:
            self._change_team_name('2')
...
################################################################################
# CHANGING COLORS, SCORES & TEAM NAMES
################################################################################
    ...
    def _update_team_colors(self):
        ...
        self.team_name['1'].change_colors(self.settings.team_color['1'],
                                       self.settings.b_w_team_color['1'],
                                       self.settings.alt_team_color['1'])
        self.team_name['2'].change_colors(self.settings.team_color['2'],
                                       self.settings.b_w_team_color['2'],
                                       self.settings.alt_team_color['2'])



    def _change_team_name(self, team):    # '1' or '2'
        new_name = tkinter.simpledialog.askstring('',
            f'New name for team {self.settings.team_names[team]}')
        self.settings.team_names[team] = new_name
        self.team_name[team].prep_msg(new_name)
...
################################################################################
    ...
    def _save_map(self):
        ...
        map_dict = {'team_names'     : self.settings.team_names,
                    'team_color'     : self.settings.team_color,
        ...
        if filename != '':
            ...
            self.map_name = os.path.split(self.filename)[1]
            self.map_nameplate.prep_msg(self.map_name)
...
################################################################################
    ...
    def _update_screen(self):
        ...
        # draw the rects around control buttons
        self.screen.fill(self.team_panel_color, self.edit_btn_rect)
        self.screen.fill(self.team_panel_color, self.team_1_rect)
        self.screen.fill(self.team_panel_color, self.team_2_rect)

        self.map_nameplate.draw_button()

        for mode, button in self.mode_button.items():
            button.draw_button()
        self.save_button.draw_button()

        self.team_name['1'].draw_button()
        self.team_name['2'].draw_button()
