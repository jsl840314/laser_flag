...
class Settings:
    ...
    def __init__(self):
        ...
        self.laser_width = 3
        self._set_default_team_colors_and_names()



    def _set_default_team_colors_and_names(self):
        """default score limit is 21-all; default teams are
            Alice (black, red, white) vs. Bob (magenta, cyan, black)"""
        self.teams      = ['1', '2']
